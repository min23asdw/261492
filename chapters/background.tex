...
ของรูปภาพจาก application ไปยัง backend ผ่าน WebSocket (Web Real Time Communications) เพื่อให้ backend 
...
\begin{figure}[h] 
  ...
  \includegraphics[scale=0.3]{pic/mlp_1.png}\cite{NeuralNetwork}
  % \cite{NeuralNetwork}
  \end{center}
